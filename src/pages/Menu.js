	...
	render() {
        ...
        <View style={{flexDirection: 'row'}}>
            <View style={{flex: 1, flexDirection: 'column',alignItems: 'center', justifyContent: 'center',backgroundColor: '#77533B', width: width/2, height: height/3}}>
              ...
              <Text style={{fontSize: 15, color: '#f1c40f', fontWeight: 'bold'}}>My Plants</Text>
            </View>
            <View style={{flex: 1, flexDirection: 'column',alignItems: 'center', justifyContent: 'center',backgroundColor: '#92B500', width: width/2, height: height/3}}>
              ...
              <Text style={{fontSize: 15, color: '#035023', fontWeight: 'bold'}}>Plantations Tutorial</Text>
            </View>
        </View>
        <View style={{flexDirection: 'row'}}>
          <View style={{flex: 1, flexDirection: 'column',alignItems: 'center', justifyContent: 'center',backgroundColor: '#92B500', width: width/2, height: height/3}}>
            ...
            <Text style={{fontSize: 15, color: '#035023', fontWeight: 'bold'}}>Communities Sharing</Text>
          </View>
          <View style={{flex: 1, flexDirection: 'column',alignItems: 'center', justifyContent: 'center',backgroundColor: '#77533B', width: width/2, height: height/3}}>
            <Image  style={{width:96, height: 96}}
              source={require('../images/icons8-small-business-96.png')}/>
            <Text style={{fontSize: 15, color: '#f1c40f', fontWeight: 'bold'}}>Products Storefront</Text>
          </View>
        </View>
        <View style={{flexDirection: 'row'}}>
          <View style={{flex: 1, flexDirection: 'column',alignItems: 'center', justifyContent: 'center',backgroundColor: '#77533B', width: width/2, height: height/3}}>
            <Image  style={{width:96, height: 96}}
              source={require('../images/icons8-hammer-96.png')}/>
            <Text style={{fontSize: 15, color: '#f1c40f', fontWeight: 'bold'}}>Tools Marketplace</Text>
          </View>
          <View style={{flex: 1, flexDirection: 'column',alignItems: 'center', justifyContent: 'center',backgroundColor: '#92B500', width: width/2, height: height/3}}>
            <Image  style={{width:96, height: 96}}
              source={require('../images/icons8-male-user-96.png')}/>
            <Text style={{fontSize: 15, color: '#035023', fontWeight: 'bold'}}>My Profile</Text>
          </View>
        </View>
      </View>
			)
